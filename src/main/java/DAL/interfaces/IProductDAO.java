...
// @formatter:off
     ...
     * @throws DALException:
     * Error if the name of the product batch already exist.
     * Could print "Product batch name already exist. DALException thrown.".
     * @throws JunkFormatException:
     * Error if the product batch information isn't within the given boundaries for a given field.
...
// @formatter:off
     ...
     * @throws DALException:
     * Error if the product batch ID doesn't exist.
     * Could print "Product batch ID not found. DALException thrown.".
     */
    // @formatter:on
